...
## Event Registry (73 events, 19 categories)
...
| `REVIEW_REQUESTED` | Conductor dispatches the §12a reviewer sub-agent | Timestamp, Stage, Reviewer, Iteration | `tools/aidlc-log.ts review` |
| `REVIEW_COMPLETED` | Reviewer verdict read; gates the approval of a reviewer-bearing stage | Timestamp, Stage, Reviewer, Verdict, Iteration | `tools/aidlc-log.ts review --verdict` |
