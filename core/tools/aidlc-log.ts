...
// --- Subcommand: review ---
// Usage:
//   aidlc-log review --stage <slug> --reviewer <agent> --iteration <n>
//       → REVIEW_REQUESTED (fires when the conductor dispatches the reviewer)
//   aidlc-log review --stage <slug> --reviewer <agent> --iteration <n> --verdict <READY|NOT-READY>
...
// be approved without a terminal REVIEW_COMPLETED (see aidlc-orchestrate report).
