...
//       "## Event Registry (72 events, 18 categories)" .. "## Hook-Generated"
...
// (the reviewer-scope PreToolUse hook) took it to 71; reviewer-enforcement RFC
// Track 1: +REVIEW_REQUESTED +REVIEW_COMPLETED takes it to 73.
...
describe("t28 audit event-type sync (migrated from t28-audit-event-sync.sh, plan 7)", () => {
  ...
  // 71; Track 1 added REVIEW_REQUESTED/REVIEW_COMPLETED -> 73.)
